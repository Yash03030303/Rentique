...
class RentalsServiceImplTest {
 ...
 void getRentalsById_notFound_throwsException() {
     ...
     assertThrows(RentalsNotFoundException.class, () -> rentalsService.getRentalsById(1L));
 }
 ...
 void updateRentals_notFound_throwsException() {
     when(rentalsRepository.findById(1L)).thenReturn(Optional.empty());
     assertThrows(RentalsNotFoundException.class, () -> rentalsService.updateRentals(1L, sampleRental));
 }
 ...
 void deleteRentals_notFound_throwsException() {
     ...
     assertThrows(RentalsNotFoundException.class, () -> rentalsService.deleteRentals(1L));
 }
}
