...
public class Users {
	...
	@Pattern(regexp = "^(USER|SUPPLIER)$", message = "UserType must be either USER or SUPPLIER")
	...
	public Users(Long userId,
			...
			@NotBlank(message = "UserType is required") @Pattern(regexp = "^(USER|SUPPLIER)$", message = "UserType must be either USER or SUPPLIER") String userType) {
		super();
		this.userId = userId;
		this.name = name;
		this.email = email;
	...
	public String toString() {
		return "Users [userId=" + userId + ", name=" + name + ", email=" + email + ", phone=" + phone + ", userType="
				+ userType + "]";
	}
